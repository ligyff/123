...
} else if (bundleId === 'com.leapfitness.fasting') {
    console.log("168轻断食");
    obj.receipt.bundle_id = "com.leapfitness.fasting";
...
} else if (bundleId === 'com.brother.pdfreaderprofree') {
    console.log("shellbean");
    obj = {
        "environment": "Production",
        "receipt": {
            "receipt_type": "Production",
